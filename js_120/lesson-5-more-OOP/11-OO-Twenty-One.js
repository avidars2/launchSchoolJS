...
class Card {
  ...
  constructor(suit, value) {
    this.suit = suit;
    this.value = value;
    // this.points = this.calculatePoints(value); //Cards don't inherently have 'points', thats an aspect of the game
...
class TwentyOneGame {
  ...
  start() {
    ...
    while(this.player.getCash() > TwentyOneGame.LOSE_AMOUNT && this.player.getCash() < TwentyOneGame.WIN_AMOUNT) {
      ...
      //display results
      //update cash
      //empty player and dealer inventory
      this.showCards();
      this.processResult();
      this.displayResult();
      this.resetPlayers();
